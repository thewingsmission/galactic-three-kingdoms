...
List<SoldierShapePart> _boxGrinProdParts() {
  ...
  return _centerParts(<SoldierShapePart>[
    ...
    SoldierShapePart(fillVertices: roundEye(-5.7, -2.4, 1.45), fillTier: 0, strokeWidth: 0, stackRole: SoldierPartStackRole.attack),
    SoldierShapePart(fillVertices: roundEye(5.7, -2.4, 1.45), fillTier: 0, strokeWidth: 0, stackRole: SoldierPartStackRole.attack),
    SoldierShapePart(
      strokePolyline: smileArc(0, 3.2, 9, 3.1, 12),
      fillTier: 1, transparentFill: true, strokeWidth: 2.3,
...
List<SoldierShapePart> _triFuryProdParts() {
  ...
  return _centerParts(<SoldierShapePart>[
    ...
    SoldierShapePart(fillVertices: ellipseEye(-5.2, 0.1, 0.935, 1.7), fillTier: 0, strokeWidth: 0, stackRole: SoldierPartStackRole.attack),
    SoldierShapePart(fillVertices: ellipseEye(5.2, 0.1, 0.935, 1.7), fillTier: 0, strokeWidth: 0, stackRole: SoldierPartStackRole.attack),
    SoldierShapePart(
      strokePolyline: const <Offset>[Offset(-6.6, -4.3), Offset(-3.7, -3.1)],
      fillTier: 1, transparentFill: true, strokeWidth: 2.2,
    ...
    SoldierShapePart(
      strokePolyline: const <Offset>[Offset(3.7, -3.1), Offset(6.6, -4.3)],
      fillTier: 1, transparentFill: true, strokeWidth: 2.2,
      motion: SoldierPartMotion.verticalBob,
      motionSign: -1.0,
      motionAmplitudeRad: 2.5,
    ...
    SoldierShapePart(
      strokePolyline: const <Offset>[Offset(-5.6, 7.8), Offset(5.6, 6.2)],
      fillTier: 1, transparentFill: true, strokeWidth: 2.2,
      stackRole: SoldierPartStackRole.attack,
    ),
  ]);
...
List<SoldierShapePart> _orbJoyProdParts() {
  ...
  return _centerParts(<SoldierShapePart>[
    ...
    SoldierShapePart(
      strokePolyline: arcEye(-6.0, -1.5, 5.8, 2.5, 10),
      fillTier: 1, transparentFill: true, strokeWidth: 2.0,
      stackRole: SoldierPartStackRole.attack,
    ),
    SoldierShapePart(
      strokePolyline: arcEye(6.0, -1.5, 5.8, 2.5, 10),
    ...
    SoldierShapePart(
      fillVertices: openMouth(0, 3.8, 5.544, 4.7, 12),
      fillTier: 6, strokeWidth: 1.2,
      motion: SoldierPartMotion.pulseScale,
      motionAmplitudeRad: 0.3,
      stackRole: SoldierPartStackRole.attack,
    ),
